            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('stunting.*') ? 'active' : '' }}" 
                               href="{{ route('stunting.index') }}">
                                <i class="fas fa-chart-bar me-2"></i>
                                Data Stunting
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('fuzzy-time-series.*') ? 'active' : '' }}" 
                               href="{{ route('fuzzy-time-series.index') }}">
