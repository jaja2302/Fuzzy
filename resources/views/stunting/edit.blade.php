        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Data Stunting</h4>
                ...
                <div class="card-body">
                    <form action="{{ route('stunting.update', $stunting->id) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('bulan') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('bulan', $stunting->bulan) == '1' ? 'selected' : '' }}>Januari</option>
                                        <option value="2" {{ old('bulan', $stunting->bulan) == '2' ? 'selected' : '' }}>Februari</option>
                                        <option value="3" {{ old('bulan', $stunting->bulan) == '3' ? 'selected' : '' }}>Maret</option>
                                        <option value="4" {{ old('bulan', $stunting->bulan) == '4' ? 'selected' : '' }}>April</option>
                                        <option value="5" {{ old('bulan', $stunting->bulan) == '5' ? 'selected' : '' }}>Mei</option>
                                        <option value="6" {{ old('bulan', $stunting->bulan) == '6' ? 'selected' : '' }}>Juni</option>
                                        <option value="7" {{ old('bulan', $stunting->bulan) == '7' ? 'selected' : '' }}>Juli</option>
                                        <option value="8" {{ old('bulan', $stunting->bulan) == '8' ? 'selected' : '' }}>Agustus</option>
                                        <option value="9" {{ old('bulan', $stunting->bulan) == '9' ? 'selected' : '' }}>September</option>
                                        <option value="10" {{ old('bulan', $stunting->bulan) == '10' ? 'selected' : '' }}>Oktober</option>
                                        <option value="11" {{ old('bulan', $stunting->bulan) == '11' ? 'selected' : '' }}>November</option>
                                        <option value="12" {{ old('bulan', $stunting->bulan) == '12' ? 'selected' : '' }}>Desember</option>
                                    </select>
                                    @error('bulan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('stunting.index') }}" class="btn btn-outline-secondary me-md-2">
