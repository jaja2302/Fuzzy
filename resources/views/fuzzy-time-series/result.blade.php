                                ...
                                @if($fs_t1 !== '-' && $fs_t2 !== '-' && $idx_last)
                                    ...
                                    <div class="bg-white p-4 rounded-lg shadow-sm mt-4">
                                        <table class="table-auto border-collapse w-full" style="margin:0;">
                                            <thead>
                                                <tr>
                                                    <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Fuzzy {{ $tahun1 }}</th>
                                                    <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Fuzzy {{ $tahun2 }}</th>
                                                    <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Relasi</th>
                                                    <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Hasil Interval</th>
                                                    <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Prediksi {{ $tahun2 + 1 }}</th>
                                                    <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Data {{ $tahun2 }}</th>
                                                    <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700">Status</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td class="px-4 py-2 text-sm text-gray-800">{{ $fs_t1 }}</td>
                                                    <td class="px-4 py-2 text-sm text-gray-800">{{ $fs_t2 }}</td>
                                                    <td class="px-4 py-2 text-sm text-gray-800">{{ $relation }}</td>
                                                    <td class="px-4 py-2 text-sm text-gray-800">({{ $fmt($lowerB, 0) }} + {{ $fmt($upperB, 0) }}) / 2</td>
                                                    <td class="px-4 py-2 text-sm text-gray-800"><strong>{{ $fmt($predInt) }}</strong></td>
                                                    <td class="px-4 py-2 text-sm text-gray-800">{{ $fmt($val_t2) }}</td>
                                                    <td class="px-4 py-2 text-sm text-gray-800"><span class="inline-block px-2 py-1 rounded-full {{ ($statusLbl === 'Naik' ? 'bg-green-500' : 'bg-red-500') }} text-white text-xs font-semibold">{{ $statusLbl }}</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
